...
const CareerRiskIndexPage = React.lazy(() => import('./components/CareerRiskIndexPage'));
      ...
      <BrowserRouter>
        ...
        <ThemeProvider>
          ...
          <Routes>
            ...
            <Route path="/tools/career-risk-index" element={<CareerRiskIndexPage />} />
            ...
            {/* AI Job Search — 2026-05-11 "tool → service" milestone.
                Anonymous users are redirected to /register by the page
                component itself on mount, so leaving this unprotected
                at the route level is intentional (deep-link friendly). */}
