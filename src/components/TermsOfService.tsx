      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          ...
          <div className="bg-[#181530]/50 backdrop-blur-xl border border-white/[0.06] rounded-2xl p-8 lg:p-12">
            ...
            <section className={sectionClass}>
              <h2 className={headingClass}>5. Payment and Subscriptions</h2>
              <ul className={listClass}>
                ...
                <li>All prices are displayed and charged in <span className={emphasisClass}>British Pounds Sterling (GBP)</span>. Currency conversion fees, if applicable, are the responsibility of your bank or payment provider.</li>
                <li>Subscriptions automatically renew at the end of each billing period unless cancelled before the renewal date.</li>
                <li>You may cancel your subscription at any time. Upon cancellation, you retain access to the Service until the end of your current paid billing period. No further charges will be made after cancellation.</li>
                <li><span className={emphasisClass}>No refunds</span> will be issued for partially used billing periods, unused portions of a subscription, or any credits remaining at the time of cancellation.</li>
                <li>Allocated credits do not roll over from one billing period to the next. Unused credits expire at the end of each billing period.</li>
