...
function SampleAnalysisContent({ sample, t }: { sample: SampleAnalysis; t: any }) {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `This sample output was generated by Vantage AI for a real ${sample.job.company} job listing (${sample.job.url}). Candidate persona is fictional but realistic. The product is operated by an independent UK founder (sole trader). Try it free at ${SITE_URL}/register — 3 free analyses, no credit card required.`,
        },
      },
    ],
  };
  ...
  const howToSchema = {
    ...
    step: [
      ...
      { '@type': 'HowToStep', position: 6, name: 'Run your own', text: 'When you are ready, register at https://aimvantage.uk/register — 3 free analyses on signup, no credit card required.', url: `${SITE_URL}/register` },
    ],
  };
