...
// motion/react entrance animation removed 2026-05-07 — same stuck-at-opacity-0
// pattern that broke the Pricing cards. Auth surfaces must always paint.
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-8" style={{ background: 'linear-gradient(135deg, #4F46E5 0%, #7C3AED 100%)' }}>
        <div className="max-w-md text-center">
          ...
          <p className="text-white/70 text-lg">
            Get AI-powered job preparation, personalized cover letters, and interview prep that works.
          </p>
        </div>
      </div>
    </div>
