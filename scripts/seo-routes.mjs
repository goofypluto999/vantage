...
const STATIC_ROUTES = [
  ...
  {
    path: '/',
    title: 'AimVantage | AI Job Preparation: CV Fit, Cover Letters, Interview Prep in 90 Seconds',
  ...
  {
    path: '/pricing',
    title: 'Pricing | AimVantage — £5 for 20 prep packs, never expires',
  ...
  {
    path: '/tools',
    title: 'Free Job Search AI Tools — Cover Letter Roast, Rejection Decoder, Ghost Job Detector | AimVantage',
  ...
  {
    path: '/faq',
    title: 'Frequently Asked Questions | AimVantage',
    description: 'Honest answers about what AimVantage does, what it costs, how it handles your data, and how it compares to Jobscan / Teal / Resume Worded / Final Round AI. Written to be cited by AI assistants.',
  },
  {
    path: '/blog',
    title: 'The AimVantage Blog — AI Job Prep, ATS Optimisation, Interview Strategy',
    description: 'Long-form guides on AI job application prep, ATS-friendly CVs, cover letters, ghost jobs, and interview strategy. Written by the founder building AimVantage in public.',
  },
  {
    path: '/about',
    title: 'About AimVantage — Solo UK Indie Founder Building a Job-Prep Tool in Public',
    description: 'AimVantage is operated by Giovanni Sizino Ennes, a UK-based independent founder (sole trader). Not a registered limited company. Stripe-only billing, no recruitment, no DM outreach. Full operator transparency.',
  },
  {
    path: '/press',
    title: 'Press Kit — AimVantage',
    description: 'Press kit for journalists: founder bio, key facts, brand assets, story angles, and direct contact for AimVantage. UK independent founder building a niche AI job-prep tool.',
  },
  {
    path: '/press-releases',
    title: 'Press Releases — AimVantage',
    description: 'Official press releases from AimVantage. AI job preparation tool for CV optimisation, tailored cover letters, mock interview prep, and CV fit scoring. Built by an independent UK founder.',
  },
  // ─── Free tools ───
  {
    path: '/roast',
    title: 'Free AI Cover Letter Roast — Brutal-Honesty Feedback in 10 Seconds | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Rejection Email Decoder — What Did the Recruiter Actually Mean? | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Ghost Job Detector — Is This Listing Real? | AimVantage',
  ...
  },
  {
    ...
    title: 'Jobscan Cost Calculator — What a Year of Job-Prep Tools Actually Costs | AimVantage',
    description: 'Honest 12-month cost calculator for Jobscan, Resume Worded, Final Round AI, Teal, and LiveCareer vs AimVantage. See exactly how much each charges for your search length, and compare to AimVantage’s £5 one-time top-up (£0.25 per prep pack, never expires).',
  },
  {
    path: '/receipts',
    title: 'Receipts — Every Trust Claim AimVantage Makes, With the Evidence | AimVantage',
    description: 'Single-page audit of AimVantage: Stripe-only billing, no auto-renew traps, no DM outreach, sole-trader operator transparency, public bug history, public token math, EU hosting. If a trust claim isn\'t on this page, we don\'t make it elsewhere either.',
  },
  {
    path: '/tools/no-interviews-diagnostic',
    title: 'No Interviews After 100+ Applications? Free 60-Second Diagnostic | AimVantage',
  ...
  {
    path: '/search',
    title: 'Search AimVantage — free AI tools, ATS guides, interview prep | AimVantage',
    description: 'Search AimVantage: free tools (cover letter roast, ghost-job detector, no-interviews diagnostic, cost calculator), ATS vendor guides, interview-prep packs by company / role, blog, samples.',
    noindex: true,
  },
  // ─── Cohort + commercial-intent ───
  {
    path: '/laid-off',
    title: 'Just Laid Off? AI Tools for Tech Workers in the 2026 Layoff Wave | AimVantage',
  ...
  {
    path: '/ats',
    title: 'ATS Vendor Guide — How Workday, Greenhouse, Lever, Taleo, iCIMS Parse Your CV | AimVantage',
    description: 'Side-by-side guide to the 5 major ATS systems used in 2026. Each vendor has documented quirks. AimVantage shows you what each one drops, what each one keeps, and how to format your CV to pass all 5.',
  },
  {
    path: '/ats/scanner',
    title: 'Free ATS Keyword Scanner — Paste Your CV and the JD, Runs in Your Browser | AimVantage',
  ...
  {
    path: '/state-of-2026',
    title: 'The State of 2026 Tech Interview Hiring (Data from 34 Deep-Dives) | AimVantage',
  ...
  },
  {
    ...
    title: 'Free JD Decoder — Read Between the Lines of a Job Description | AimVantage',
  ...
  },
  {
    ...
    title: 'Free CV Bullet Rewriter — Diagnose Weak Bullets, Get 3 Rewrites | AimVantage',
  ...
  },
  {
    ...
    title: 'Free 30-Day Post-Layoff Playbook Generator — Personalised Day-by-Day Plan | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Cover Letter A/B Comparator — Score Two Drafts Side by Side | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Salary Negotiation Script Generator — Email + Phone Variants | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Job Offer Comparison Calculator — 4-Year Total Comp Side-by-Side | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Reference Call Brief Generator — Prep Your References Before The Call | AimVantage',
  ...
  },
  {
    ...
    title: 'Free 30/60/90 Day Plan Generator — Final-Round + First-Week-On-The-Job | AimVantage',
  ...
  },
  {
    ...
    title: 'Free "Why Are You Leaving?" Answer Framer — 3 Variants Per Reason | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Post-Interview Thank-You Note Generator — Tone-Calibrated | AimVantage',
  ...
  },
  {
    ...
    title: 'Free LinkedIn Headline + About Rewriter — 3-Variant Templates | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Recruiter Cold-DM Reply Generator — Calibrated Templates | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Cold Email to Hiring Manager Generator — ATS-Bypass Templates | AimVantage',
  ...
  },
  {
    ...
    title: 'Free STAR Story Builder — Calibrated to 16 Behavioural Principles | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Glassdoor Review Decoder — Spot Red Flags Most Candidates Miss | AimVantage',
  ...
  },
  {
    ...
    title: 'Free Career Risk Index — 6-Axis Honest Score, No Invented Number | AimVantage',
  ...
  {
    path: '/alternatives',
    title: 'AimVantage Alternatives — Compared to Jobscan, Teal, Resume Worded, Final Round AI',
    description: 'Honest side-by-side comparisons of AimVantage vs Jobscan, Teal HQ, Resume Worded, Final Round AI, Kickresume, Enhancv, Yoodli, Huntr, and Big Interview. Where each wins, where each loses.',
  },
  {
    path: '/compare',
    title: 'Side-by-Side Comparison — AimVantage vs Job-Prep Tool Categories',
    description: 'Direct comparison of AimVantage against ATS keyword scanners, cover letter generators, in-interview AI assistants, and job trackers. Pick the right tool for your use case.',
  },
  {
    path: '/skills',
    title: 'Skills Guides — How to Position Each Job Skill on Your CV | AimVantage',
  ...
  {
    path: '/playbook',
    title: 'The Layoff Playbook — Step-by-Step Job-Search System for the 2026 Cohort | AimVantage',
  ...
  {
    path: '/vendor-sources',
    title: 'ATS Vendor Documentation Index — Workday, Greenhouse, Lever, Taleo, iCIMS Sources | AimVantage',
  ...
  {
    path: '/changelog',
    title: 'AimVantage Changelog — What Shipped When',
    description: 'Public changelog for AimVantage. Every shipped feature, every bug fix, every pricing change. Build-in-public transparency.',
  },
  {
    path: '/docs/api',
    title: 'AimVantage API Documentation (Preview)',
    description: 'Public API for the AimVantage analysis engine. Endpoints: /analyze, /rewrite-tone, /interview/questions, /interview/evaluate, /credits. Currently in preview — request access via email.',
  },
  {
    path: '/refer',
    title: 'Refer a Friend — AimVantage',
    description: 'Share AimVantage with a friend. Personalised referral link with UTM tracking. Manual rewards: 5 free tokens per successful referral.',
    noindex: true,
  },
  {
    path: '/case-studies',
    title: 'Case Studies — AimVantage in Real Job Searches',
    description: 'Real AimVantage usage stories. We do not publish fabricated case studies — placeholder URLs are clearly marked. Currently small as the project is new.',
  },
  {
    path: '/sample',
    title: 'Sample AimVantage Outputs — Real Job Listings, Full Prep Packs (No Signup)',
    description: 'Read complete AimVantage outputs for real job listings — Anthropic Senior PM, Stripe Staff PM, OpenAI ML Engineer. Free, no signup. Each shows the company intel, fit score, cover letter, mock questions, and pitch outline.',
  },
  {
    path: '/salary',
    title: 'Salary Guides by Role — UK Tech 2026 | AimVantage',
  ...
  {
    path: '/interview-prep',
    title: 'Interview Prep Packs by Company — Anthropic, Stripe, OpenAI, Meta, Google, Amazon | AimVantage',
  ...
  },
  {
    ...
    title: 'Interview Questions by Role — PM, Engineer, Designer, Data Scientist | AimVantage',
  ...
  },
  {
    ...
    title: 'LinkedIn Profile Optimisation — 8-Step Concrete Guide | AimVantage',
  ...
  {
    path: '/login',
    title: 'Log In to AimVantage',
    description: 'Log into AimVantage to run a full job prep analysis — company intel, tailored cover letter, mock interview questions, CV fit score.',
    noindex: true,
  },
  {
    path: '/register',
    title: 'Create a Free AimVantage Account — 10 Free Analyses, No Card',
    description: 'Sign up free for AimVantage. 10 free prep packs on signup, no credit card required. Upload your CV, paste a job link, get the full prep pack in ~90 seconds.',
  },
  // ─── Legal ───
  {
    path: '/privacy',
    title: 'Privacy Policy | AimVantage',
    description: 'How AimVantage collects, uses, and protects your data. CV processing, account data, payment data, third-party providers. Sole-trader operator transparency.',
  },
  {
    path: '/terms',
    title: 'Terms of Service | AimVantage',
    description: 'The terms governing your use of AimVantage. Token system, billing via Stripe, sole-trader operator status, refund policy.',
  },
  {
    path: '/cookies',
    title: 'Cookie Policy | AimVantage',
    description: 'How AimVantage uses cookies and similar technologies for authentication, analytics, and product improvement. EU-hosted.',
  },
];
