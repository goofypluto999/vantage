...
datePublished: Mon May 04 2026 16:57:03 GMT+0000 (Coordinated Universal Time)
cuid: cmorfzhq2000102jpf66o1ksj
...
tags: ai, job-search, chatgpt, interview-prep
...
1. **Prompt 1** — Company brief from the job link.
2. **Prompt 2** — CV-to-role fit, with gaps named.
3. **Prompt 3** — 10 likely questions, ranked by probability.
4. **Prompt 4** — STAR story bank from your CV.
5. **Prompt 5** — Mock-drill rebuttals to your weakest answer.
6. **Prompt 6** — Opener and closer for the call itself.
...
1. Read every output out loud. If a sentence feels stiff, rewrite it in your own voice. The fastest tell of AI-written prep is the rhythm.
2. Insert one specific number or detail per answer. Generic outputs do not have numbers.
3. Remove every "leverage", "synergy", "passionate about". You probably do not say those words in real life.
